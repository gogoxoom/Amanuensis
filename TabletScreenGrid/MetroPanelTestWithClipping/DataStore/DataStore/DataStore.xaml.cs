...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		private string _NewDataStore = string.Empty;
		...
		public string NewDataStore
		{
			...
			set
			{
				...
				if (this._NewDataStore != value)
				{
					this._NewDataStore = value;
					this.OnPropertyChanged("NewDataStore");
				}
			}
		}
	}
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/MetroPanelTestWithClipping;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string NewDataStore
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.NewDataStore;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.NewDataStore = value;
			}
		}
	}
}
